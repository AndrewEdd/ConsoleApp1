...
{
	//int dataF, dataF1; //� � � � � sourceArray.txt
	int s1, s2;
	bool flagOfSeries = false; // � � (0 � 1)
	bool sorted = false;
	fstream f, f1, f2;
	...
	while (!sorted)
	{
		...
		while (f >> s2) //� � � � � � sourceArray.txt � � � � f1 �  f2
		{
...
inline int Array::binaryHuntAndSearch(int huntNumber, int findNumber, int& index)
{
	int indxHunt = 0;
	this->binarySearch(huntNumber,indxHunt);
	int left = indxHunt;
	int right = indxHunt;
